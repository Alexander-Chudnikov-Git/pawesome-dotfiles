...
local lazy_plugins    = require("plugins.init")
local custom_graphics = require("graphics.init");
local custom_settings = require("config.init");
local custom_settings = require("events.init");
